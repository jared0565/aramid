...
- `aramid status` -- open findings, new-since-baseline, unrotated historical secrets.
...
rotate it**, then retire the finding with
`aramid ledger mark-rotated <id> --reason "rotated in <system>"`.
